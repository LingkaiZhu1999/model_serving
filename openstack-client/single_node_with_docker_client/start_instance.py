...
instance = nova.servers.create(name="prod_server_with_docker_"+str(identifier), image=image, flavor=flavor, key_name='LingkaiZhu',userdata=userdata, nics=nics,security_groups=secgroups)
