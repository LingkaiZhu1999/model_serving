...
instance_prod = nova.servers.create(name="prod_server_group_8"+str(identifier), image=image, flavor=flavor, key_name='de2group8',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="dev_server_group_8"+str(identifier), image=image, flavor=flavor, key_name='de2group8',userdata=userdata_dev, nics=nics,security_groups=secgroups)
